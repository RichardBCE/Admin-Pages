...
define('TEXT_PRODUCTS_DESCRIPTION_APPROVAL_PAGE', 'Products Message Approval Page:');
...
//BOF Linkmatics attribute sets plus
define('TEXT_PRODUCTS_ATTRIBUTES_SET', 'Attribute Sets:');
// EOF Linkmatics attribute sets plus
...
define('TEXT_CATEGORIES_STATUS', 'Status');
...
define('TEXT_FORM_FILL_EDITOR_PRODUCT', 'Form Fill Editor Product Cross Reference');
define('TEXT_ADVANCED_EDITOR_PRODUCT', 'Advance Editor Product Cross Reference');

define('TEXT_IMAGE_ALLOW_FRONT', 'Allow Upload Front');
define('TEXT_IMAGE_ALLOW_BACK', 'Allow Upload Back');
define('TEXT_IMAGE_UPLOAD_PREFFERED_BUT_NO_PREVIEW', 'Allow upload preferred files, but no online previews (option)');
define('TEXT_USE_CUSTOM_PACKAGE_WEIGHT', 'Use custom package weight?');
define('TEXT_CUSTOM_PACKAGE_WEIGHT', 'Custom package weight');
define('TEXT_CATEGORIES_AFT_ALT_TITLE', 'Aft - Alt category title');
define('TEXT_AFT_USE_CATEGORY', 'Aft - use category title');
